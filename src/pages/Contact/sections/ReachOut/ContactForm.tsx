  ...
  return (
    <div className="box-border min-w-0 rounded-[26px] bg-carely-form-grey p-[clamp(26px,3vw,52px)]">
      ...
      >
        ...
        <button
          type="submit"
          className="mt-[clamp(8px,1vw,16px)] min-h-[66px] w-full rounded-[14px] bg-carely-apricot text-[19px] font-bold text-carely-white transition-colors duration-[250ms] hover:bg-carely-lime hover:text-carely-deep focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-[3px] focus-visible:outline-carely-deep motion-reduce:transition-none min-[640px]:col-span-2"
        >
          Submit Message
        </button>
      </form>
