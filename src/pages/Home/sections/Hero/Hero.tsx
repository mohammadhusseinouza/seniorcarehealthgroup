 ...
 *
 * Below 640px, MobileHero renders the dedicated Direction 1b composition
 * instead (README "Responsive Strategy" — mobile <=~640px, unchanged
 * desktop/tablet above it).
 */
  ...
  return (
    <>
      ...
      <section
        ...
        className="hidden w-full box-border bg-carely-ivory px-[clamp(20px,3.2vw,48px)] pt-2 pb-[60px] min-[640px]:block"
      >
