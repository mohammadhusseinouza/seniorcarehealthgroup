...
export function WhoWeAreImages() {
  ...
  return (
    ...
    >
      <div data-pos="back" className="who-reveal who-image absolute top-0 left-0 h-[80%] w-[62%] overflow-hidden rounded-card">
      ...
      <div
        data-pos="front"
        className="who-reveal who-image absolute top-[20%] left-[32%] z-[2] h-[80%] w-[68%] overflow-hidden rounded-card shadow-[0_18px_44px_rgba(39,58,41,0.14)]"
      >
        <div className="who-image-inner h-full w-full">
